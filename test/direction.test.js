...
it('Should revert back to original position due to grid exceeded error', () => {
  const result = direction.moveRobot('MOVE', [gridSize.x, gridSize.y, 'N']);
